...
int main() {
  ...
  char *start1 = (char *)(blk1) + sizeof(struct header);
  char *start2 = (char *)(blk2) + sizeof(struct header);
  ...
  if (blk1 != NULL && blk2 != NULL) {
    ...
    // Print out the data in each block of memory
    ...
    write(STDOUT_FILENO, "Somethings up! no blk1 or blk2 location (its NULL)\n",
          42);
  }
